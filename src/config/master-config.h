/* src/config/master-config.h.  Generated from master-config.h.in by configure.  */
/* src/config/master-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/masterpay/master/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "master Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "master Core 1.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mastercore"
