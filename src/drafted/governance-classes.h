 ...
 *
 *   // network
 *   CmasterNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.master.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CmasterNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: masterNetwork
// //   -- signature requirements : Key1(User)
// class CmasterNetworkVariable : public CGovernanceObject
// {
// private:
