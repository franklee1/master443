...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "masterNetwork") type = masterNetwork;
    if(strType == "masterNetworkVariable") type = masterNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == masterNetwork) s = "masterNetwork";
    if(type == masterNetworkVariable) s = "masterNetworkVariable";
